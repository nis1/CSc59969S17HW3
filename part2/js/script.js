...
var tooltip = d3.select('body').append('div')
    ...
    .style('box-shadow', '3px 3px 6px rgba(0, 0, 0, 0.2)')
    .style('opacity',0)
...
chart.selectAll('circle')
    ...
    .style('fill', function (d){
      if (d.Doping ==""){ return '#82EA25'; }
      else { return '#E15858'; }
    })
    .attr('class', 'dot')
    .attr('r', 7)
    .attr('cx', function(d) {
      return xAxis(d.Seconds - fastestTime);
    })
    .attr('cy', function(d) {
      return yAxis(d.Place-3);
    })
...
chart.selectAll('text')
  .data(jsonSorted)
    ...
    .attr('x', function(d) { return xAxis(d.Seconds - fastestTime);})
    .attr('y', function(d) { return yAxis(d.Place-3);})
...
chart.selectAll('circle')
    ...
    tempcolor = this.style.fill
       ...
       d3.select(this).attr('r', 7).style('fill', 'black');
    })
...
chart.append('g')
      .attr('transform','translate(' + 15 + ',' + (height + margin.top) + ')')
      .style('font-size','12px')
      .call(d3.axisBottom(xAxis).tickFormat(formatMinutes).ticks(7));
...
chart.append('circle')
      .attr('r', 7)
      .attr('cx', function(d) {return xAxis(23.5);})
      .attr('cy', function(d) {return yAxis(33.6);})
      .style('fill', '#82ea25')

chart.append('circle')
    .attr('r', 7)
    .attr('cx', function(d) {return xAxis(23.5);})
    .attr('cy', function(d) {return yAxis(31.6);})
    .style('fill', '#E15858')

chart.append('text')
    .attr('x', function(d) {return xAxis(19);})
    .attr('y', function(d) {return yAxis(33.3);})
     .style('font-size','12px')
          .text(function(d){
...
chart.append('text')
    .attr('x', function(d) {return xAxis(19);})
    .attr('y', function(d) {return yAxis(31.3);})
     .style('font-size','12px')
          .text(function(d){
